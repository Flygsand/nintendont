...
{
	{
		0xC9, 0x7D, 0x1E, 0xD0, 0x71, 0x90, 0x47, 0x3F, 0x6A, 0x66, 0x42, 0xB2, 0x7E, 0x4A, 0xDB, 0xCD, 0xB6, 0xF8, 0x8E, 0xC3,			//	0
	},
	{
		0x21, 0xD0, 0xC0, 0xEE, 0x25, 0x3D, 0x8C, 0x9E, 0x02, 0x58, 0x66, 0x7F, 0x3C, 0x1B, 0x11, 0xBC, 0x90, 0x1F, 0x33, 0xE2,			//	1
	},
	{
		0xBA, 0xDC, 0x60, 0x15, 0x33, 0x33, 0x28, 0xED, 0xB1, 0x0E, 0x72, 0xF2, 0x5B, 0x5A, 0xFB, 0xF3, 0xEF, 0x90, 0x30, 0x90, 		//	2
	},
	{
		0xBC, 0x17, 0x36, 0x81, 0x7A, 0x14, 0xB2, 0x1C, 0xCB, 0xF7, 0x3A, 0xD6, 0x8F, 0xDA, 0x57, 0xF8, 0x43, 0x78, 0x1A, 0xAE, 		//	3
	},
	{
		0xD9, 0x39, 0x63, 0xE3, 0x91, 0xD1, 0xA8, 0x5E, 0x4D, 0x5F, 0xD9, 0xC2, 0x9A, 0xF9, 0x3A, 0xA9, 0xAF, 0x8D, 0x4E, 0xF2, 		//	4
	},
	{
		0xD8, 0x12, 0xAC, 0x09, 0xDC, 0x24, 0x50, 0x6B, 0x0D, 0x73, 0x3B, 0xF5, 0x39, 0x45, 0x1A, 0x23, 0x85, 0xF3, 0xC8, 0x79, 		//	5
	},	
	{
		0x37, 0x44, 0xC3, 0x82, 0xC8, 0x98, 0x42, 0xD4, 0x9D, 0x68, 0x83, 0x1C, 0x2B, 0x06, 0x7E, 0xC7, 0xE8, 0x64, 0x32, 0x44, 		//	6
	},
	{
		0xDA, 0x39, 0xA3, 0xEE, 0x5E, 0x6B, 0x4B, 0x0D, 0x32, 0x55, 0xBF, 0xEF, 0x95, 0x60, 0x18, 0x90, 0xAF, 0xD8, 0x07, 0x09,			//	7
	},	 
	{
		0x8E, 0x5C, 0xCA, 0xEA, 0xA9, 0x84, 0x87, 0x02, 0xFB, 0x5C, 0x19, 0xD4, 0x18, 0x6E, 0xA7, 0x7B, 0xE5, 0xB8, 0x71, 0x78,			//	8
	},	 
	{
		0xBC, 0x1E, 0x0A, 0x75, 0x09, 0xA6, 0x3E, 0x7C, 0xE6, 0x30, 0x44, 0xBE, 0xCC, 0x8D, 0x67, 0x1F, 0xA7, 0xC7, 0x44, 0xE5,			//	9
	},	 
	{
		0x14, 0x93, 0x40, 0x30, 0x0D, 0x93, 0x24, 0xE3, 0xD3, 0xFE, 0x86, 0xA5, 0x68, 0x2F, 0x4C, 0x13, 0x38, 0x61, 0x31, 0x6C,			//	10
	},	
	{
		0x09, 0xF1, 0x6B, 0x48, 0x57, 0x15, 0xEB, 0x3F, 0x67, 0x3E, 0x19, 0xEF, 0x7A, 0xCF, 0xE3, 0x60, 0x7D, 0x2E, 0x4F, 0x02, 		//	11
	},
	{
		0x21, 0xD0, 0xC0, 0xEE, 0x25, 0x3D, 0x8C, 0x9E, 0x02, 0x58, 0x66, 0x7F, 0x3C, 0x1B, 0x11, 0xBC, 0x90, 0x1F, 0x33, 0xE2,			//	12
	},
};
...
{
	{
		0x02, 0x9f, 0x00, 0x12, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0x00, 0x00, 0x02, 0xff, 0x00, 0x00,		//	0
	},
	{
		0x02, 0x9F, 0x00, 0x12, 0x00, 0x00, 0x00, 0x00, 0x02, 0xFF, 0x00, 0x00, 0x02, 0xFF, 0x00, 0x00,		//	1
	},
	{
		0x00, 0x00, 0x00, 0x00, 0x02, 0x9f, 0x0c, 0x10, 0x02, 0x9f, 0x0c, 0x1f, 0x02, 0x9f, 0x0c, 0x3b,		//	2
	},
	{
		0x00, 0x00, 0x00, 0x00, 0x02, 0x9f, 0x0e, 0x76, 0x02, 0x9f, 0x0e, 0x85, 0x02, 0x9f, 0x0e, 0xa1,		//	3
	},
	{
		0x00, 0x00, 0x00, 0x00, 0x02, 0x9f, 0x0e, 0xb3, 0x02, 0x9f, 0x0e, 0xc2, 0x02, 0x9f, 0x0e, 0xde,		//	4
	},
	{
		0x02, 0x9f, 0x00, 0x12, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0x00, 0x00, 0x02, 0xff, 0x00, 0x00,		//	5
	},
	{
		0x02, 0x9f, 0x00, 0x12, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0x00, 0x00, 0x02, 0xff, 0x00, 0x00,		//	6
	},
};
...
void DoDSPPatch( char *ptr, u32 Version )
{
	switch( Version )
	{
		...
		{
			// 5B3
			W32( (u32)ptr + 0xB66 + 0, 0x02BF05F0 );
		
			// 5F0
			W32( (u32)ptr + 0xB66 + 0x7A, 0x02001000 );
			W32( (u32)ptr + 0xB66 + 0x7E, 0x00FEFFD8 );
			W32( (u32)ptr + 0xB66 + 0x82, 0x02DF02DF );

			// 56C
			W32( (u32)ptr + 0xAD8 + 0, 0x02BF05F8 );
		
			// 5F8
			W32( (u32)ptr + 0xAD8 + 0x118, 0x02001000 );
			W32( (u32)ptr + 0xAD8 + 0x11C, 0x147F2ED8 );
			W32( (u32)ptr + 0xAD8 + 0x120, 0x02DF02DF );
		} break;
		/*
			0x5c8 - 15 opcodes
		...
		*/
		...
		/*
			...
			0x05ab lrri load and increase, patch all 
			0x0660
...
// Widescreen hack by Extrems
...
#ifdef DEBUG
						dbgprintf("Patch:Applied **IntrruptHandler patch\n");
#endif
					} break;
	...
	if( *(vu32*)(0x00000000) == 0x475A4C45 )	// ZeldaWW USA
	{
		dbgprintf("Patch:Zelda:WW USA Hacks\n");
